...
MANUAL_COURSES: list[dict] = [
    ...
    },
    {
        ...
        "crsContents": (
            ...
            "지나며 양구의 청정 자연환경과 6.25전쟁 격전지였던 도솔산, 펀치볼 전투의 흔적을 엿볼 "
            "수 있는 구간이다. 민간인통제구역이 포함되므로 신분증 지참이 필요하며, 돌산령 옛 고갯길"
    ...
    },
    {
        ...
        "crsTotlRqrmHour": "300",
        "crsContents": (
            "DMZ두루미평화타운에서 고석정으로 이어지는 길이다. 청정 구역으로 겨울 철새를 다수 "
            "만나볼 수 있는 구간이며, 유네스코 세계지질공원으로 인증된 한탄강의 주상절리를 감상할 "
            "수 있다. 예약이 필요한 16코스를 대체하여 이용 가능한 우회노선이다."
        ),
        "sigun": "강원 철원군",
        "brdDiv": "DNWW",
